  ...
  return (
    ...
    >
      ...
      <div className={`${styles.heroContent} ${isMobile ? styles.mobileContent : ''}`}>
        ...
        <div className={`${styles.meditationPlayer} ${isMobile ? styles.mobilePlayer : ''}`}>
          {/* Player Header */}
          <div className={`${styles.playerHeader} ${isMobile ? styles.mobilePlayerHeader : ''}`}>
            <h2 className={`${styles.playerTitle} ${isMobile ? styles.mobilePlayerTitle : ''}`}>Evening Calm</h2>
            <p className={`${styles.playerSubtitle} ${isMobile ? styles.mobilePlayerSubtitle : ''}`}>Gentle Breathing & Relaxation</p>
            <p className={`${styles.sessionDuration} ${isMobile ? styles.mobileSessionDuration : ''}`}>12 minutes</p>
          </div>
        ...
        <button 
          className={`${styles.ctaButton} ${isMobile ? styles.mobileCta : ''}`}
        ...
        <p className={`${styles.description} ${isMobile ? styles.mobileDescription : ''}`}>
          The Stone Elf offers a quiet space to welcome, understand, and grow with every feeling.
        </p>

        {/* App Store Buttons - Order 5 on mobile */}
        <div className={`${styles.appButtons} ${isMobile ? styles.mobileAppButtons : ''}`}>
          <a 
            href="#" 
